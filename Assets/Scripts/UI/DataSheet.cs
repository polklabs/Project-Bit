...
public class DataSheet
{
    ...
    // Memory -----------------------------------------------------------------------------------
    public static DataSheet SHIFT_REG_8 = new DataSheet("8-Bit Shift Register (PQ210)", "PQ210_SftRegister8Bit").SetLayers("IC16_PQ210", "IC16_outline", "IC16_VG", "IC16_dip_2");
